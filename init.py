...
<<<<<<< HEAD
bugman = Entity(spritebuggman[0], spritebuggman, 600, 450, True)
bugman2 = Entity(spritebuggman[0], spritebuggman, 750, 300, True)
=======
bugman = Entity(spritebuggman[0], spritebuggman, 400, 450, True)
bugman2 = Entity(spritebuggman[0], spritebuggman, 750, 500, True)
>>>>>>> 4c30a5520084f1203834d5f17532e9cc821e1d6c
